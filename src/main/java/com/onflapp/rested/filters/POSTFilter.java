...
class POSTWrapper extends SlingHttpServletRequestWrapper {
	private com.onflapp.rested.filters.ParameterMap mypars;

	public POSTWrapper (SlingHttpServletRequest req) {
		super (req);
...
@Service
@Properties ( { @Property (name = EngineConstants.FILTER_NAME, value = "POSTFilter"),
...
public class POSTFilter implements Filter {
	...
	public void doFilter (ServletRequest request, ServletResponse response, FilterChain chain) throws IOException,
		...
		if (request instanceof SlingHttpServletRequest && ((HttpServletRequest)request).getMethod().equalsIgnoreCase("POST")) {
			...
			POSTWrapper wrapper = new POSTWrapper(slingReq);
